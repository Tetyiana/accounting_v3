...
// Одиниці виміру (за КСПОВО ДК 011-96 і практикою обліку).
// Список подається як пропозиції у datalist — користувач може обрати або вписати свою.
export const UNITS = [
  // штучні
  'шт', 'пара', 'комплект', 'набір', 'пачка', 'уп', 'ящик', 'палет',
  // маса
  'г', 'кг', 'ц', 'т',
  // об'єм
  'мл', 'л', 'м³', 'дм³', 'см³',
  // довжина / площа
  'мм', 'см', 'м', 'км', 'м²', 'см²',
  // тара для косметики і рідин
  'флакон', 'туба', 'банка', 'пляшка', 'ампула', 'саше', 'пакет', 'блістер',
  // час / послуги
  'год', 'хв', 'день', 'місяць', 'послуга', 'сеанс', 'відвідування',
  // інше
  'рулон', 'аркуш', 'бухта',
];
